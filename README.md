...
4. <mark>If the file includes CSS, create a new CSS file in styles and name it "yourpage.css". Then, add <code>&lt;link rel="stylesheet" href="/styles/yourpage.css"&gt;</code> in the head tag of _includes/base.njk</mark>
